 ...
 */
class ExoLayoutBuilderHtmlEntityFormController extends FormController {
  ...
  public function getContentResult(Request $request, RouteMatchInterface $route_match) {
    ...
    if (!isset($form['#layout_builder_element_keys']) && isset($form['layout_builder__layout']['widget'])) {
      $form['#layout_builder_element_keys'] = $form['layout_builder__layout']['widget']['#parents'];
    }
    ...
    if (isset($form['#layout_builder_element_keys'])) {
      ...
      $build['layout_builder']['#weight'] = 1000;
